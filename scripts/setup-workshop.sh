...
function usage() {
    ...
    echo "   --gogs-user-count [count]          Number of users to be created on Gogs. Default 50"
...
OPENSHIFT_MASTER=console.training.openshift.ca
OPENSHIFT_APPS_HOSTNAME=apps.training.openshift.ca
